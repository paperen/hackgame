...
<?php if ( $this->isajax ): ?>
    ...
    <script type="text/javascript">
    timer(function(){$('#passtip').remove();$('#lvl2_form form').fadeIn('fast');}, 2500);
    </script>
    <?php } ?>
<?php else: ?>
<?php $this->need('header'); ?>
        <!-- left box -->
    	<div class="float_left box commonbox lvl2 radius">
        	<h5 class="title b_title">
            	<span class="icon blub_icon"></span>
            	<span class="mission mission2"></span>
            ...
            <div class="box_inner">
                <div class="main_box radius">
                    ...
                    <div class="main_form lvl2_form" id="lvl2_form">
                        ...
                        <p>
                            ...
                            <input type="button" name="submit" id="submit" class="enter_btn" value="ENTER" onclick="do_submit('#lvl2_form');" />
                        </p>
                        </form>
                    </div>
                </div>
