...
class first extends HG_Controller
{
	...
	public function index() {
		...
		$this->hg_view->load( 'first_index', $this->data );
	}
	...
	public function view( $id ) {
		...
		$this->hg_view->load( 'first_view', $this->data );
	}
	...
	public function admin() {
		if ( isset( $_POST['submit'] ) && $_POST['submit'] && HG_Arsenal::valid_token() ) {
			try {
				...
				// 设置第二关
				HG_Arsenal::set_hgsession( 'second' );
		...
		$this->hg_view->load( 'first_admin', $this->data );
	}
	...
	private function _footer() {
		...
		$link_arr[] = array(
			'txt' => '管理后台',
			'url' => HG_Arsenal::base_url( "first/admin" ),
		);
