...
class DB_mysql
{
    ...
    function add_perfix($table){
        return $this->perfix.$table;
    }
    ...
    function halt($message = '', $sql = '')
    {
        ...
        if($this->debug)
        {
            echo '<div style="font-size:12px;text-align:left; border:1px solid #9cc9e0; padding:1px 4px;color:#000000;font-family:Arial, Helvetica,sans-serif;"><span>'.$this->errormsg .'</span></div>';
            exit;
        }
    }
}
